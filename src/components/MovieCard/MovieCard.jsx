    ...
    return (
        <div className={styles.movie_card}>
            ...
            <div className={styles.movie_card__poster}>
                <img
                    ref={posterRef}
                    src={data.poster || posterPlaceholderPNG}
                    alt=""
                    onError={
                        () => posterRef.current.src = posterPlaceholderPNG
                    }
                />
            </div>
